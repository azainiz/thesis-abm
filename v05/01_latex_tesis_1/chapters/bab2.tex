...
Lingkungan terdiri dari kondisi dan habitat yang mengelilingi agen saat mereka bertindak dan berinteraksi dalam model. Lingkungan dapat memengaruhi keputusan agen dan sebaliknya. Kemudian, spasial suatu lingkungan dalam ABM umumnya memiliki dua jenis, yaitu ruang diskrit dan kontinu. Dalam representasi matematis, pada ruang kontinu, di antara setiap pasangan titik terdapat titik lain, sedangkan pada ruang diskrit, meskipun setiap titik memiliki titik tetangga, terdapat pasangan titik yang tidak memiliki titik lain di antara keduanya, sehingga setiap titik terpisah dari titik lainnya. Namun, ketika diimplementasikan dalam ABM, semua ruang kontinu harus diimplementasikan sebagai aproksimasi, sehingga ruang kontinu diwakili sebagai ruang diskrit di mana jarak antara titik-titik sangat kecil (Wilensky dan Rand, 2015).
...
Penelitian yang bertujuan untuk mengetahui pertumbuhan ekonomi di sepanjang jalan tol yang ditandai dengan jumlah mobil yang mengunjungi \textit{rest area} pernah dilakukan oleh Suheri dan Viridi (2019) dengan ABM yang digabungkan dengan model gravitasi atau \textit{gravity model} (GM).
...
\begin{figure}[H]
	...
	\caption[Sistem simulasi oleh Suheri dan Viridi (2019)]{Sistem simulasi oleh Suheri dan Viridi (2019) yang terdiri dari beberapa bagian: (A) kota A, (B) kota B, (C) jalan tol dari A ke B, (D) jalan tol dari B ke A, (E) rest area di jalan dari A ke B, dan (F) rest area di jalan dari B ke A, dan (G) dua jenis agen yang berbeda (Suheri dan Viridi, 2019).}
...
\begin{itemize}
	...
	\item Pergerakan agen secara diskrit atau menggunakan \textit{grid}.
...
\begin{figure}[H]
	...
	\caption[Ilustrasi lingkungan berupa interior suatu gedung pada simulasi oleh Firdausyi (2023)]{Ilustrasi lingkungan berupa interior suatu gedung pada simulasi oleh Firdausyi (2023) yang terdiri dari dinding (coklat), titik keluar (hijau tua), serta agen yang mewakili anak-anak (hijau muda), orang dewasa (kuning), manusia lanjut usia (jingga), dan manusia dengan disabilitas (biru tua) (Firdausyi, 2023).}
